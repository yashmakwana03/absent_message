...
> **Smart. Fast. Reliable.**
> An offline-first mobile application designed to streamline the attendance process for faculty and teachers. Built with Flutter & SQLite.

---

## 🚀 Overview

**Attendance Manager** eliminates the need for paper registers. It allows faculty to manage students, departments, and daily attendance records directly from their smartphone. With powerful features like **Offline Support**, **Excel Exports**, and **Auto-Backup**, your data is always safe and accessible.
...
* **📂 Local Database:** Powered by **SQLite** for instant loading and 100% offline access.
* **🛡️ Data Safety:** Built-in **Backup & Restore** functionality.
...
**Yash Makwana**
* 🎓 Computer Science Student at RK University
* 💼 Aspiring MERN & Flutter Developer
* 📧 [Email Me](mailto:yashmakwana2275@gmail.com)
